    ...
    <main className="scroll-smooth bg-slate-950 text-slate-950">
      ...
      <section id="contact" className="relative overflow-hidden bg-slate-950 py-24 text-white">
        ...
        <div className="container relative z-10 mx-auto grid gap-10 px-4 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <form className="rounded-[2.5rem] bg-white p-6 text-slate-950 shadow-2xl shadow-black/25 sm:p-8 lg:p-10">
            ...
            <button type="submit" className="mt-6 inline-flex w-full items-center justify-center gap-3 rounded-2xl bg-blue-700 px-8 py-5 text-lg font-black text-white shadow-2xl shadow-blue-700/25 transition-all hover:-translate-y-1 hover:bg-blue-800">Get Free Estimate <ArrowRight className="h-5 w-5" /></button>
          </form>
        </div>
      </section>
