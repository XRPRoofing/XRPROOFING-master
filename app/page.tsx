...
const homepageFaqs = [
  ...
  { q: "Do you provide documentation for storm damage?", a: "Yes. We inspect the roof, document damage with photos and measurements, and prepare a written repair estimate. With your permission, if your adjuster inspects the roof, we can be on-site to walk through the physical damage we documented and explain the repair requirements — there is no charge for this. We do not negotiate or interpret insurance coverage — decisions about your claim are between you and your insurer." },
