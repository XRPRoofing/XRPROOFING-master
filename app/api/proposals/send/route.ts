...
export async function POST(req: NextRequest) {
  try {
    ...
    const coverPhoto = data.coverPhoto || "/images/logo.png";
    ...
    const html = `
      <div style="margin:0;background:#f1f5f9;padding:0;font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
        <div style="background:#e9eef3;padding:28px 0;text-align:center;">
          <img src="${new URL("/images/logo.png", data.proposalLink).toString()}" alt="XRP Roofing" style="width:150px;height:auto;display:inline-block;background:#fff;" />
        </div>
