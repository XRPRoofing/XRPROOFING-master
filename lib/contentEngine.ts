...
export const cityFaqSets: Array<Array<{ q: string; a: string }>> = [
  [
    ...
    { q: "Do you document storm damage?", a: "Yes. We inspect the roof, photograph and measure the damage, and prepare a written repair estimate you may share with your insurer. With your permission, if your adjuster inspects the roof, we can be on-site to walk through the documented damage. We do not negotiate or interpret insurance coverage." },
